...
const BattleStats = ({ battles }) => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-red-500/10 via-orange-500/10 to-yellow-500/10 rounded-2xl p-3 sm:p-4 border border-red-200/50 dark:border-red-500/30">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:space-x-6 text-xs sm:text-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3 sm:gap-4">
        {/* Total Prize Pool */}
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-2xl p-4 sm:p-6 shadow-lg border border-white/20 relative overflow-hidden group hover:scale-105 transition-transform">
      ...
      <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-2xl p-4 sm:p-6 shadow-lg border border-white/20 overflow-x-auto p-4 scrollbar-hide">
        <div className="flex flex-col sm:flex-row items-center justify-between mb-4 sm:mb-6 gap-2 sm:gap-0">
          ...
          <div className="text-xs bg-gray-100 dark:bg-gray-700 px-2 sm:px-3 py-1 rounded-full text-gray-600 dark:text-gray-400">
            Real-time
          </div>
        </div>
        ...
        <div className="space-y-2 sm:space-y-4">
          {battles?.map((battle) => (
            <div key={battle.id} className="flex flex-col sm:flex-row items-center space-y-1 sm:space-y-0 sm:space-x-4">
              ...
              <div className="flex-grow w-full">
                <div className="flex flex-col sm:flex-row items-center justify-between mb-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className={`text-xs font-bold ${getIntensityColor(battle.intensity)}`}>
              ...
              <div className="flex-shrink-0 text-right mt-1 sm:mt-0">
      ...
      <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-2xl p-4 sm:p-6 shadow-lg border border-white/20 overflow-x-auto p-4 scrollbar-hide">
        <div className="flex flex-col sm:flex-row items-center justify-between mb-4 sm:mb-6 gap-2 sm:gap-0">
          ...
          <div className="text-xs bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 px-2 sm:px-3 py-1 rounded-full">
            Live Rankings
          </div>
        </div>
        ...
        <div className="space-y-2 sm:space-y-3">
          {liveMetrics.topPerformers.map((pet, index) => (
            <div
              key={pet.id}
              className="flex items-center space-x-3 sm:space-x-4 p-2 sm:p-3 rounded-xl bg-gradient-to-r from-gray-50/50 to-white/50 dark:from-gray-700/50 dark:to-gray-800/50 hover:scale-105 transition-transform"
            >
              <div className="flex-shrink-0 relative">
                <div className="text-2xl sm:text-3xl">{pet.avatar}</div>
                {index === 0 && (
              ...
              <div className="flex-grow">
                <div className="flex flex-col sm:flex-row items-center justify-between">
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white text-xs sm:text-base">
                      {pet.name}
                    </h4>
      ...
      <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-2xl p-4 sm:p-6 shadow-lg border border-white/20 p-4 scrollbar-hide">
        <div className="flex flex-col sm:flex-row items-center justify-between mb-4 sm:mb-6 gap-2 sm:gap-0">
          <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white flex items-center space-x-2">
            <Activity className="text-green-500" size={20} />
            <span>Recent Activity</span>
          </h3>
          <div className="text-xs bg-green-100 dark:bg-green-900/30 text-green-600 px-2 sm:px-3 py-1 rounded-full animate-pulse">
            Live Feed
          </div>
        </div>

        <div className="space-y-2 sm:space-y-3 max-h-48 sm:max-h-64 overflow-y-auto pr-1 scrollbar-hide">
          {/* Simulated activity feed */}
          <div className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-xl bg-blue-50/50 dark:bg-blue-900/20">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-xl bg-green-50/50 dark:bg-green-900/20">
            <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
            <div className="flex-grow">
              <p className="text-xs sm:text-sm text-gray-700 dark:text-gray-300">
                New battle started:{' '}
                <span className="font-bold text-green-600">Tournament Finals</span>
              </p>
              <p className="text-xs text-gray-500">15 seconds ago</p>
            </div>
          </div>

          <div className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-xl bg-yellow-50/50 dark:bg-yellow-900/20">
            <div className="w-2 h-2 bg-yellow-500 rounded-full animate-pulse" />
            <div className="flex-grow">
              <p className="text-xs sm:text-sm text-gray-700 dark:text-gray-300">
                <span className="font-bold text-yellow-600">DragonDoge</span> is on a 7-win streak! 🔥
              </p>
              <p className="text-xs text-gray-500">32 seconds ago</p>
            </div>
          </div>

          <div className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-xl bg-purple-50/50 dark:bg-purple-900/20">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-xl bg-red-50/50 dark:bg-red-900/20">
