      ...
      <>
        ...
        <section className="relative min-h-screen flex items-center justify-center ">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-black bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 bg-clip-text text-transparent mb-6 leading-tight">
              Welcome to
              <br />
              Meme Pet League
            </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              ...
              <span className="text-yellow-400 font-bold">$GUI</span> Becomes
              Your Meme Pet's Power Source
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button
                size="lg"
                className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-bold px-8 py-4 text-lg transform hover:scale-105 transition-all duration-300 shadow-2xl"
              >
              ...
              <Button
                size="lg"
                variant="bordered"
                className="border-2 border-purple-400 text-purple-300 hover:bg-purple-400/10 font-bold px-8 py-4 text-lg transform hover:scale-105 transition-all duration-300"
              >
                Learn More
              </Button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <Card className="bg-white/5 backdrop-blur-lg border border-white/10">
                <CardBody className="text-center py-6">
                  ...
                  <div className="text-gray-300">Active Pets</div>
                </CardBody>
              </Card>
              <Card className="bg-white/5 backdrop-blur-lg border border-white/10">
                <CardBody className="text-center py-6">
                  ...
                  <div className="text-gray-300">$GUI Staked</div>
                </CardBody>
              </Card>
              <Card className="bg-white/5 backdrop-blur-lg border border-white/10">
                <CardBody className="text-center py-6">
                  ...
                  <div className="text-gray-300">Daily Battles</div>
                </CardBody>
              </Card>
            </div>
          </div>
        ...
        <section className="py-20 px-4 relative">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="bg-gradient-to-br from-red-600/20 to-pink-600/20 backdrop-blur-lg border border-red-400/30 hover:scale-105 transition-transform duration-300">
                <CardBody className="p-6 text-center">
                  <div className="text-4xl mb-4">💰</div>
                  <h3 className="text-xl font-bold mb-3 text-red-300">Spend</h3>
              ...
              <Card className="bg-gradient-to-br from-green-600/20 to-emerald-600/20 backdrop-blur-lg border border-green-400/30 hover:scale-105 transition-transform duration-300">
                <CardBody className="p-6 text-center">
                  <div className="text-4xl mb-4">💎</div>
              ...
              <Card className="bg-gradient-to-br from-blue-600/20 to-cyan-600/20 backdrop-blur-lg border border-blue-400/30 hover:scale-105 transition-transform duration-300">
                <CardBody className="p-6 text-center">
                  <div className="text-4xl mb-4">🔒</div>
              ...
              <Card className="bg-gradient-to-br from-purple-600/20 to-indigo-600/20 backdrop-blur-lg border border-purple-400/30 hover:scale-105 transition-transform duration-300">
                <CardBody className="p-6 text-center">
                  <div className="text-4xl mb-4">🔥</div>
